...
def automate(schedule, quiet):
    ...
    from core.research.automation import DailyAutomation
...
def cron_show():
    ...
    Example:
        kdp-scout cron show
    """
    from core.research.cron_helper import (
...
def cron_install(schedule):
    ...
    """
    from core.research.cron_helper import install_cron, generate_cron_entry
...
def cron_uninstall():
    ...
    """
    from core.research.cron_helper import uninstall_cron
